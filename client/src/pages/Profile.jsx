...
const Profile = () => {
  ...
  return user ? (
    <div className='relative h-full overflow-y-scroll bg-gray-50 p-6 profile-page'>
      <div className='max-w-3xl mx-auto'>
        {/* Profile Card */}
        <div className='profile-card bg-white rounded-2xl shadow overflow-hidden'>
          {/* Cover Photo */}
          <div className='profile-cover h-40 md:h-56 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200'>
        ...
        {/* Tabs */}
        <div className='mt-6'>
          <div className='profile-tabs bg-white rounded-xl shadow p-1 flex max-w-md mx-auto'>
